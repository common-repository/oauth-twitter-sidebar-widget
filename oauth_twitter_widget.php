...
Description: Takes OAuth tokens and is compatible with Twitter API 1.1. Creates a sidebar widget that displays the latest twitter updates for any user with public tweets.
Author: Sumit Malik
